...
def create_sum_order_items_df(df):
    sum_order_items_df = df.groupby("product_name").quantity_x.sum().sort_values(ascending=True).reset_index()
...
sns.barplot(x="quantity_x", y="product_name", data=sum_order_items_df.sort_values(by="quantity_x", ascending=False).head(5), hue="product_name", legend=False, palette=colors, ax=ax[0])
...
sns.barplot(x="quantity_x", y="product_name", data=sum_order_items_df.sort_values(by="quantity_x", ascending=True).head(5), hue="product_name", legend=False, palette=colors, ax=ax[1])
